...
const form = useForm({
  ...
  latitud: props.sede.latitud,
  longitud: props.sede.longitud,
      ...
      <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
          <div class="p-6 bg-white border-b border-gray-200">
            ...
            <p class="text-xl text-center font-semibold text-gray-600 py-4 uppercase">Editar sede</p>
