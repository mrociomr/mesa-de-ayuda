...
const form = useForm({
  nombre: props.tipoSolucion.nombre,
  estado: props.tipoSolucion.estado,
});

const estados = ref([ 'Activo' ,'Inactivo']);

const updateForm = () => {
  form.patch(`/tipo-solucion/${props.tipoSolucion.id}`);
};
</script>
<template>
  <AuthenticatedLayout>
    <Head title="Editar Tipo de Solución" />
      ...
      <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
          <div class="p-6 bg-white border-b border-gray-200">
            ...
            <p class="text-xl text-center font-semibold text-gray-600 py-4 uppercase">Editar tipo de solución</p>
