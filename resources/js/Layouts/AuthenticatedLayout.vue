...
const items = ref([]); // Utilizamos ref para mantener una reactividad en items.

const userRoles = ref([]); // Variable para almacenar los roles
const userPermissions = ref([]); // Variable para almacenar los permisos
const permissionNames = ref([]); // Array para almacenar nombres de permisos

//const hasDependenciaIndexPermission = ref(false); // Variable reactiva para dependencia.index
//const hasSolucionIndexPermission = ref(false); // Variable reactiva para solucion.index

const getUsers = async () => {
  try {
    const response = await axios.get("/verificate");
    //console.log(response.data);
    userRoles.value = response.data.userRoles;
    userPermissions.value = response.data.userPermissions;

    permissionNames.value = userPermissions.value.map((permission) => permission.name);
    sessionStorage.setItem('auth_permisos', JSON.stringify(permissionNames.value));
...
const hasPermission = (permission) => {
  const authPermisos = sessionStorage.getItem('auth_permisos');
  return authPermisos ? authPermisos.includes(permission) : false;
};
...
<template>
        ...
        <div class="flex items-center ml-3">
          ...
          >
            <div class="px-4 py-3" role="none">
              ...
              <p class="text-sm font-medium truncate text-gray-900" role="none">
  ...
  <div v-if="permission.name === 'dependencia.index'"> -->
    <li v-if="hasPermission('dependencia.index')">
        <SiderbarLink
      ...
      >
        ...
        <span class="ml-3 flex-1 whitespace-nowrap">Dependencias</span>
      </SiderbarLink>
    </li>
  <!-- </div>
</div> -->
                ...
                <li>
                  ...
                  >
                    ...
                    <span class="ml-3 flex-1 whitespace-nowrap">Incidencias Atendidas</span>
                  </SiderbarLink>
                </li>
                ...
                <li>
                  ...
                  >
                    ...
                    <span class="ml-3 flex-1 whitespace-nowrap">Oficinas</span>
                  </SiderbarLink>
                </li>
                <li>
                  <SiderbarLink
                ...
                <li>
                  ...
                  >
                    ...
                    <span class="ml-3 flex-1 whitespace-nowrap">Reportes</span>
                  </SiderbarLink>
                </li>
